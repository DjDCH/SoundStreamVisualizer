...
public class SoundAnalyzer extends Observable implements Runnable {
    ...
    private static final int SAMPLES_QUEUE_BUFFER = 40000;
    private static final int SAMPLES_QUEUE_EXTRA = 350; // XXX: Ideally, we want this value as lower as possible, but the system do not keep up below 350
